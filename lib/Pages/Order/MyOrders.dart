...
class OrdersNotifier extends StateNotifier<List<Order>> {
  ...
  Future<void> fetchOrders({String? filterDate}) async {
    ...
    if (assignedId != null) {
      final apiUrl = "https://api-jfnhkjk4nq-uc.a.run.app/assignedTo/$assignedId";
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          final fetchedOrders = responseData
              .where((data) {
                if (filterDate != null) {
              ...
              .map((data) {
                try {
                  final items =
                    ...
                    return OrderItem(
                      itemName: item['item_name']?.toString() ?? 'Unknown Item',
                      itemPrice:
                  ...
                  final orderDate = data['date']?.toString() != null
